...
import image from "../AC_Ohm/axis.jpeg";
import img from "./LCCIRCUIT.png";
            ...
            <div className="dropdown ">
              ...
              <div class="dropdown-content">
                <li>
                  ...
                  <ul>2. Take the Input Volatage and Set its Frequency.</ul>
                  <ul>
                    3. Plot the Phasor Diagram By clicking the Button "Plot
                    Phasor".
                  </ul>
                  <ul>
                    4. Now Check the Values of the Output and Add them to the
                    Table.{" "}
                  </ul>
                  <ul>5. Plot The data.</ul>
                  <ul>6. See The Output.</ul>
                </li>
              </div>
            </div>{" "}
          </div>
      ...
      ZERO){" "}
          ...
          <div className="containercal box2">
            ...
            <div className="outputs">
              ...
              <h5 style={{ padding: "5px" }}>
                {" "}
                Phase Angle ={phase_angle.toFixed(2)} radian
