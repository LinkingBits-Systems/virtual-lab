...
export default function Home() {
  ...
  var Xc =
    1 / (2 * Math.PI * currentState.frequency * currentState.capacitance);
  var k = Xc - 2 * Math.PI * currentState.frequency * currentState.inductance;
  if (currentState.capacitance == 0) {
    k = -2 * Math.PI * currentState.frequency * currentState.inductance;
    Xc = 0;
  }
            ...
            <div className="dropdown ">
              ...
              <div class="dropdown-content">
                <li>
                  ...
                  <ul>
                    {" "}
                    1.Set the values for The Parameters(Resistance,Inductance,
                    Capacitance).
                  </ul>
                  <ul>2. Set Input Voltage and its Frequency.</ul>
                  <ul>
                    3. observe the input voltage and output current waveform in
                    CRO
                  </ul>
                  <ul>
                    5. Plot the Phasor Diagram By hovering the cursor on "Plot
                    Phasor" button.
                  </ul>
                  <ul>
                    6. Now Check the Values of the Output and Add them to the
                    Table.{" "}
                  </ul>
                  <ul>7.Click on "Plot data" to Plot graph.</ul>
                  <ul>8.observe the graph.</ul>
                </li>
              </div>
            </div>{" "}
          </div>
          ...
          <div>
            <div className="input-table tbl">
              ...
              >
                ...
                {/* <button class="button-85 btn "> */}
                {/* <Link to="/Phasor">
                  <span class="button-85 btn ">SEE PHASOR</span>
                </Link> */}
                <div className="dropdown ">
                  <button class="dropbtn">SEE PHASOR & ADD TO TABLE </button>
                  <div class="dropdown-content">
                    <div>
                      {/* <button
        className="button-85"
                        ...
                        <div className="phasor box2">
                          ...
                          >
                            ...
                            <Phasor
                              ...
                              vc={mulfac * Xc * currentState.current}
                              vl={
                                mulfac *
                                2 *
                                Math.PI *
                                currentState.frequency *
                                currentState.inductance *
                                currentState.current
                              }
                              // amplitude={currentState.voltage}
                              //frequency={currentState.frequency}
          ...
          <div className="containercal box2">
            ...
            <div className="outputs">
              <h5 style={{ padding: "5px" }}>
                ...
                {(currentState.voltage / Math.sqrt(2)).toFixed(2)} V
              </h5>
              {/* <h4> Resistance={currentState.resistance} Ohm</h4> */}
              <h5 style={{ padding: "5px" }}>
                {" "}
                Angular Frequency(2*pi*f) ={" "}
                {(2 * Math.PI * currentState.frequency).toFixed(2)} rad/s
              </h5>
              <h5 style={{ padding: "5px" }}>
              ...
              <h5 style={{ padding: "5px" }}>
                Capacitive Reactance(XC) = {Xc.toFixed(2)} Ohm
              </h5>
              <h5 style={{ padding: "5px" }}>
                Voltage Across resistance(Vr) ={" "}
                {(currentState.resistance * currentState.current).toFixed(2)} v
              </h5>
              <h5 style={{ padding: "5px" }}>
              ...
              <h5 style={{ padding: "5px" }}>
                Voltage Across Capacitance(Vc) ={" "}
                {(Xc * currentState.current).toFixed(2)} v
              </h5>
              ...
              <h5 style={{ padding: "5px" }}>
                {" "}
                Phase Angle ={(phase_angle * (180 / Math.PI)).toFixed(2)} deg
                {/* {currentState.phase}{"dfgh"} {k} {"fgh"}{currentState.current} radian */}{" "}
              </h5>
            </div>
          </div>
          <div
          ...
          >
            ...
            <div className="outputs">
              <h4 style={{ padding: "3px" }}>
                {" "}
                Current(peak)={Number(currentState.current).toFixed(2)} A
              </h4>
              <h4 style={{ padding: "3px" }}>
                {" "}
                Current(rms)={(currentState.current / Math.sqrt(2)).toFixed(
                  2
                )}{" "}
                A
              </h4>
